...
/// Signature for the callback that's called when an [ExpansionPanelNoIcon] is
/// expanded or collapsed.
///
/// The position of the panel within an [ExpansionPanelListNoIcon] is given by
/// [panelIndex].
typedef ExpansionPanelCallback = void Function(int panelIndex, bool isExpanded);

/// Signature for the callback that's called when the header of the
/// [ExpansionPanelNoIcon] needs to rebuild.
...
///
/// See [ExpansionPanelListNoIcon] for a sample implementation.
///
/// See also:
///
///  * [ExpansionPanelListNoIcon]
///  * <https://material.io/design/components/lists.html#types>
class ExpansionPanelNoIcon {
  /// Creates an expansion panel to be used as a child for [ExpansionPanelListNoIcon].
  /// See [ExpansionPanelListNoIcon] for an example on how to use this widget.
  ///
...
/// This identifier allows the [ExpansionPanelListNoIcon] to determine
/// which [ExpansionPanelRadio] instance should be expanded.
///
/// See [ExpansionPanelListNoIcon.radio] for a sample implementation.
class ExpansionPanelRadio extends ExpansionPanelNoIcon {
...
/// normal [ExpansionPanelListNoIcon] widgets, it is the responsibility of the parent
/// widget to rebuild the [ExpansionPanelListNoIcon] with updated values for
/// [ExpansionPanelNoIcon.isExpanded]. For [ExpansionPanelListNoIcon.radio] widgets, the
...
///
/// {@tool dartpad}
/// Here is a simple example of how to use [ExpansionPanelListNoIcon].
///
...
/// See also:
///
///  * [ExpansionPanelNoIcon], which is used in the [children] property.
///  * [ExpansionPanelListNoIcon.radio], a variant of this widget where only one panel is open at a time.
///  * <https://material.io/design/components/lists.html#types>
class ExpansionPanelListNoIcon extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const ExpansionPanelListNoIcon({
    super.key,
    this.children = const <ExpansionPanelNoIcon>[],
  ...
  ///
  /// {@tool dartpad}
  /// Here is a simple example of how to implement ExpansionPanelListNoIcon.radio.
  ///
  /// ** See code in examples/api/lib/material/expansion_panel/expansion_panel_list.expansion_panel_list_radio.0.dart **
  /// {@end-tool}
  const ExpansionPanelListNoIcon.radio({
    super.key,
  ...
  /// fashion to [ListBody].
  final List<ExpansionPanelNoIcon> children;

  /// The callback that gets called whenever one of the expand/collapse buttons
  /// is pressed. The arguments passed to the callback are the index of the
  /// pressed panel and whether the panel is currently expanded or not.
  ///
  /// If [ExpansionPanelListNoIcon.radio] is used, the callback may be called a
  /// second time if a different panel was previously open. The arguments
  /// passed to the second callback are the index of the panel that will close
  /// and false, marking that it will be closed.
  ///
  /// For [ExpansionPanelListNoIcon], the callback should call [State.setState] when
  /// it is notified about the closing/opening panel. On the other hand, the
  /// callback for [ExpansionPanelListNoIcon.radio] is intended to inform the parent
  ...
  /// only used when initializing with the [ExpansionPanelListNoIcon.radio]
  /// constructor.)
  ...
  /// Defines color for the divider when [ExpansionPanelNoIcon.isExpanded] is false.
  ///
  /// If [dividerColor] is null, then [DividerThemeData.color] is used. If that
  /// is null, then [ThemeData.dividerColor] is used.
  final Color? dividerColor;

  /// Defines elevation for the [ExpansionPanelNoIcon] while it's expanded.
  ///
  ...
  /// between the [ExpansionPanelListNoIcon.children] when they're expanded.
  ///
  /// Defaults to `16.0`.
...
class _ExpansionPanelListState extends State<ExpansionPanelListNoIcon> {
  ...
  @override
  void didUpdateWidget(ExpansionPanelListNoIcon oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (widget._allowOnlyOnePanelOpen) {
      assert(_allIdentifiersUnique(), 'All ExpansionPanelRadio identifier values must be unique.');
      // If the previous widget was non-radio ExpansionPanelListNoIcon, initialize the
 ...
 void _handlePressed(bool isExpanded, int index) {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      ...
      final ExpansionPanelNoIcon child = widget.children[index];
